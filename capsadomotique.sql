...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 30 mai 2019 à 11:59
...
CREATE TABLE `module_electricite` (
  ...
  `id_container` int(11) NOT NULL,
  `consommation_max` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `module_electricite` (`id_module_electricite`, `consommation`, `date_changement`, `id_container`, `consommation_max`) VALUES
(11, 127.256, '2019-01-01 00:00:00', 1, 25),
(12, 1554.11, '2019-01-08 00:00:00', 1, 25),
...
INSERT INTO `module_gaz` (`id_module_gaz`, `consommation`, `date_changement`, `id_container`, `consommation_max`) VALUES
(1, 12, '2019-03-07', 2, 0),
(2, 24, '2019-03-05', 1, 55),
(4, 56, '2019-03-05', 1, 55);
...
CREATE TABLE `module_habitation` (
  `id_module_habitation` int(11) NOT NULL,
  `id_container` int(11) NOT NULL,
  `nombre_badge` int(11) NOT NULL,
  `poid` int(11) NOT NULL,
  `nombre_appareil_electronique` int(11) NOT NULL,
  `nombre_connexion` int(11) NOT NULL,
  `date_changement` datetime DEFAULT NULL,
  `nombre_badge_max` int(11) NOT NULL,
  `poid_max` int(11) NOT NULL,
  `nombre_appareil_electronique_max` int(11) NOT NULL,
...
INSERT INTO `module_habitation` (`id_module_habitation`, `id_container`, `nombre_badge`, `poid`, `nombre_appareil_electronique`, `nombre_connexion`, `date_changement`, `nombre_badge_max`, `poid_max`, `nombre_appareil_electronique_max`, `nombre_connexion_max`) VALUES
(1, 2, 15, 100, 2, 4, '2019-05-01 10:00:00', 0, 0, 0, 0),
(2, 1, 10, 150, 4, 2, '2019-04-02 15:00:00', 55, 0, 0, 0),
...
--
-- Index pour la table `module_gaz`
--
ALTER TABLE `module_gaz`
  ADD PRIMARY KEY (`id_module_gaz`),
  ADD KEY `id_container` (`id_container`);

--
-- Index pour la table `module_habitation`
--
ALTER TABLE `module_habitation`
  ADD PRIMARY KEY (`id_module_habitation`),
  ADD KEY `id_container` (`id_container`);
...
--
ALTER TABLE `container`
  MODIFY `id_container` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT pour la table `module_habitation`
--
ALTER TABLE `module_habitation`
  MODIFY `id_module_habitation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `vue`
--
ALTER TABLE `vue`
  MODIFY `id_vue` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
